...
public class AddToCart extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        String soid = request.getParameter("ownerid");
System.out.println(sid+"AddToCart");
       // out.print("<form action=StoreItemRequest>");
        out.print("<form action=StoreItemRequest method=post>");
         out.println("<input type=hidden name=oid value="+ soid +">"); 
       ...
       out.print("<td ><b style=color:red name=ProductId >" + sid + "</b></td>");
        out.println("<td style=color:red><input type=hidden name=ProductId value="+ sid +"></td> "); 
        System.out.println(sid+"Sample");
